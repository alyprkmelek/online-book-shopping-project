...
<html lang="en">
  <head>
    ...
    <title>Online Book Shopping System</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-user-circle-o"></i> <span>Yönetim Paneli</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="https://sapuzman.com/wp-content/plugins/all-in-one-seo-pack/images/default-user-image.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="urun.php"><i class="fa fa-shopping-bag"></i> Kitaplar </a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="https://sapuzman.com/wp-content/plugins/all-in-one-seo-pack/images/default-user-image.png" alt=""><?php echo $kullanicicek['kullanici_adsoyad'] ?>
