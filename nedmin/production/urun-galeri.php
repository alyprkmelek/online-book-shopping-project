          ...
          <div class="x_panel">
            <div class="x_title">
             <div align="left" class="col-md-6">
              <h2 >Kitap Fotoğraf İşlemleri <small>
                <?php
              ...
              <input type="hidden" name="urun_id" value="<?php echo $_GET['urun_id']; ?>">
                ...
                <div align="right" class="col-md-6">
                  ...
                  <a class="btn btn-success" href="urun-foto-yukle.php?urun_id=<?php echo $_GET['urun_id'];?>"><i class="fa fa-plus" aria-hidden="true"></i> Kitap Fotoğraf Yükle</a>
                </div>
                <div class="clearfix"></div>
              </div>
