              ...
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kategori Seç<span class="required">*</span>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                 ...
                 <!-- kategori seçme bitiş -->
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-2 col-xs-12 " for="first-name">Kitap Detay <span class="required">*</span>
                        </label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kitap Öne Çıkar <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
