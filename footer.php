			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					<div class="title-widget-bg">
						<div class="title-widget-cursive">Online Book Shopping</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="http://www.onlinebookshopping.com">www.onlinebookshopping.com</a></div>
