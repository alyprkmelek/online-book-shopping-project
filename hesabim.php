	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<center><a href="sifre-guncelle"><img width="400" src="https://cdn.webtekno.com/media/cache/content_detail_v2/article/75992/sifremi-unuttum-demeye-son-iste-sifrenizi-sizin-yerinize-hatirlayan-5-uygulama-1568546633.png"></a></center>
			</div>
		</div>
	</div>
</form>
